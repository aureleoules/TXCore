...
RUN apt-get -y install autoconf libtool libgmp3-dev
...
RUN mkdir /go/src/github.com/aureleoules/txcore
WORKDIR /go/src/github.com/aureleoules/txcore
COPY . /go/src/github.com/aureleoules/txcore
